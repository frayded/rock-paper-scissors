...
//Scoring, global for the last console.log accessibility
let playerScore = 0;
let computerScore = 0;
let tieScore = 0;
let failInput = 0;
...
console.log("Game over, you won " + playerScore + " rounds, lose " + computerScore + " rounds, and tied for " + tieScore + " rounds!\n" + "Also, made " + failInput + " typos, just so you know.");